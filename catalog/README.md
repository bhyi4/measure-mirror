...
| [self-catch/](self-catch/) | 자가적발 — "너무 좋다"를 스스로 의심해 잡은 거짓양성 | 18 |
| [fn-guard/](fn-guard/) | 거짓음성 가드 — 음성을 믿기 전 확인해야 했던 것 | 12 |
| [contamination/](contamination/) | 데이터/인코딩 오염 — 측정 이전에 무너진 입력 | 3 |
