...
- **실사례**: metacog_lang_selfmonitor — 기질검증에서 frozen neoul_recall_last가 과제 자체를 chance로 수행(free-gen recall acc 0.00~0.20, forced-choice ~0.5) → 가설 KILL이 아닌 UNTESTABLE terminal GUARD로 철회. 출처: db/curated/false_negative_guards.jsonl — ledger_retraction:metacog_lang_selfmonitor
