...
- **실사례**: (동역학계 함수 식별 실험) spike의 '場'이 실은 평범 MLP였음 → 실제 WaveODEFunc를 import해 Lorenz-96 재시험 → 0.992 동률, 음성 robust 확정. 출처: db/curated/false_negative_guards.jsonl — field_real_edge_control_axis_closed
