...
| **[action-mirror](https://github.com/mirror-stack/action-mirror)** | Did the agent actually **do** it? (chain-linked action history + mutual witness) | action |
| **[provenance-mirror](https://github.com/mirror-stack/provenance-mirror)** | Where did this **artifact** come from? (distribution fingerprinting, tracing) | artifact |
...
Plus a shared **[witness hub](https://github.com/mirror-stack/mirror-witness)** — a public, CI-verified
